...
export const INDUSTRY_PRESETS: Record<string, IndustryPreset> = {
  ...
  it_technology: {
    ...
    keywords: [
      "managed IT services company UK",
      "IT support provider UK",
      "cloud services company UK",
      "cybersecurity firm UK",
      "software development company UK",
      "SaaS company UK B2B",
    ],
    websiteSignals: ["managed services", "IT support", "cloud", "cybersecurity", "software", "SaaS", "technology solutions", "digital transformation"],
  },
